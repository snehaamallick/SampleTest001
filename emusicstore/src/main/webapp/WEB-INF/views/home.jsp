        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img class="first-slide home-image" src="<c:url value="/resources/images/3.jpg" />" alt="First slide">
                    <div class="container">
                ...
                <div class="item">
                    <img class="second-slide home-image" src="<c:url value="/resources/images/5.jpg" />" alt="Second slide">
                    <div class="container">
                        <div class="carousel-caption">
                ...
                <div class="item">
                    <img class="third-slide home-image " src="<c:url value="/resources/images/6.jpg" />" alt="Third slide">
                    <div class="container">
                        <div class="carousel-caption">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <a class="btn btn-default" href="<c:url value="/product/productList?searchCondition=Instrument" />" role="button">
                        <img class="img-circle" src="<c:url value="/resources/images/home-hphone-mphone.jpg"/>" alt="Instrument Image" width="140" height="140">
                    </a>
                ...
                <div class="col-lg-4">
                    <a class="btn btn-default" href="<c:url value="/product/productList?searchCondition=Guitar" />" role="button">
                        <img class="img-circle" src="<c:url value="/resources/images/home-guitar.jpg"/>" alt="Instrument Image" width="140" height="140">
                    </a>
                ...
                <div class="col-lg-4">
                    <a class="btn btn-default" href="<c:url value="/product/productList?searchCondition=Piano" />" role="button">
                        <img class="img-circle" src="<c:url value="/resources/images/home-piano.jpg"/>" alt="Instrument Image" width="140" height="140">
                    </a>
